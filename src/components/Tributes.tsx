...
const CHILD_TRIBUTES = [
  ...
  { name: 'Chukwuma', message: "Dearest Mom and Dad, so much of who I am comes from the strength, faith, and love you gave us. When life gets tough, I draw on everything you taught me — to keep going, to stand with courage, and to treat people with kindness. Every good thing I carry into the world was shaped by my upbringing, and I owe that foundation to you. Thank you for being our constant example. I love you both deeply." },
